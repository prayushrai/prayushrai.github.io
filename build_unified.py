...
function runPredict(){
  ...
  // Reveal the counselling pop-up 40 s after the user predicts (once per session)
...
// === Counselling pop-up modal (40 seconds after Predict) ===
...
document.addEventListener('keydown', function(e){
  if (e.key === 'Escape') closeCounsellingModal();
});
</script>
...
<!-- Counselling pop-up modal (revealed 40s after Predict) -->
