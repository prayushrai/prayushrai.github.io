...
<!-- Sticky bottom Razorpay CTA — present on every screen, follows scroll -->
<div class="razorpay-sticky">
  <div class="razorpay-embed-btn"
       data-url="https://pages.razorpay.com/pl_Sft6W2qxhB1ed1/view"
       data-text="Save your Career - ₹299 Only"
       data-color="#c2410c"
       data-size="large"></div>
</div>
...
<!-- Bootstrap the Razorpay embed-button bundle (renders all .razorpay-embed-btn elements) -->
<script>
  (function(){
